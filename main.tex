...
Post\-doctoral Researcher (in collaboration with Sandia National Labs)
\begin{itemize}
    \item Investigating hydroxide and chloride solvation and transport in hydrated, precise polymer electrolytes 
    \item Refined structure factor calculations to achieve agreement between simulation and experiment
    \item Created a force\-field for simulating new precise polymer membranes with experimental analogues
...
\begin{itemize}
    ...
    \item Theoretical investigations on the glass transition (particularly in polymers)
    \begin{itemize}
        \item Reinstated and updated in-house job submission software and version control
        \item Extensive use of high-performance/distributed computing
        (SLURM, Bash, C++, CUDA)
...
\begin{itemize}
    \item Investigating dynamics of bead-spring co\-polymers
\end{itemize}

\paragraph{Department of Corrosion Engineering;}
Research Assistant
\begin{itemize}
    \item Developed a class for predicting damage to capsule-embedded coatings in Python (Anaconda)
...
\begin{itemize}
    \item Macromolecules Volume 58, Issue 18 Supplemental Cover Art (2025)
